...
volume = 10 ;      % amplification factor for audio output - often needed to
   ...
   while done == 0,
      ...
      elseif button=='i',
            if all(current>0),
                ...
                try
                    wavwrite(x_temp,afs_org,16,'C:\Users\stacy\Documents\TempAuditSounds\tempsound.wav');
                catch
                    disp('Error writing to C:\Users\stacy\Documents\TempAuditSounds\tempsound.wav, close other programs and try again')
                end
